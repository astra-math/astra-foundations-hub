        ...
        <div className="container-astra">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <blockquote className="border-l border-gold/30 pl-6 flex flex-col justify-between">
              ...
              <cite className="text-cream text-xs md:text-sm not-italic mt-auto block">— Anushka, G6 student, Inventure Academy, Bangalore</cite>
            </blockquote>
            <blockquote className="border-l border-gold/30 pl-6 flex flex-col justify-between">
              <p className="text-cream/70 text-sm md:text-base italic leading-relaxed mb-4">
                "The sessions opened up a completely new way of thinking about mathematics for my child."
              </p>
              <cite className="text-cream text-xs md:text-sm not-italic mt-auto block">— Ketaki, Mother of a G5 student, Phoenix Greens, Hyderabad</cite>
            </blockquote>
            <blockquote className="border-l border-gold/30 pl-6 flex flex-col justify-between">
              <p className="text-cream/70 text-sm md:text-base italic leading-relaxed mb-4">
              ...
              <cite className="text-cream text-xs md:text-sm not-italic mt-auto block">— Sudhanshu, Father of a G7 student, The Knowledge Habitat, Gurugram</cite>
            </blockquote>
          </div>
        </div>
      </section>
