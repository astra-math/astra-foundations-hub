  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 bg-[#25D366] text-white p-3.5 rounded-full shadow-lg hover:bg-[#1EBE55] hover:-translate-y-1 transition-all z-50 flex items-center justify-center pointer-events-auto"
